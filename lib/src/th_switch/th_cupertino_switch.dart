...
///
/// {@tool dartpad}
/// This example shows a toggleable [THCupertinoSwitch]. When the thumb slides to
...
/// {@tool snippet}
///
/// This sample shows how to use a [THCupertinoSwitch] in a [ListTile]. The
...
class THCupertinoSwitch extends StatefulWidget {
  ...
  @override
  State<THCupertinoSwitch> createState() => _THCupertinoSwitchState();
...
class _THCupertinoSwitchState extends State<THCupertinoSwitch>
  ...
  @override
  void didUpdateWidget(THCupertinoSwitch oldWidget) {
...
class _TDCupertinoSwitchRenderObjectWidget
  ...
  final Color thumbColor;
  final ValueChanged<bool>? onChanged;
  final _THCupertinoSwitchState state;
...
class _RenderTDCupertinoSwitch extends RenderConstrainedBox {
  _RenderTDCupertinoSwitch({
    ...
    required _THCupertinoSwitchState state,
  })  : _value = value,
  ...
  final _THCupertinoSwitchState _state;
