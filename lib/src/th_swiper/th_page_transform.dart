...
/// TH默认PageTransformer
class THPageTransformer extends PageTransformer {
  ...
  /// 普通margin的卡片式
  THPageTransformer.margin({this.margin = 6.0})
      : fade = 1,
        scale = 1;

  /// 缩放或透明的卡片式
  THPageTransformer.scaleAndFade({this.fade = 1, this.scale = 0.8})
      : margin = 0.0;

  THPageTransformer({this.fade, this.scale, this.margin});
