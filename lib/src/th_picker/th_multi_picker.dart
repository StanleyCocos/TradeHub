  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: backgroundColor ?? THColor.white,
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        gradient: LinearGradient(
                            ...
                            colors: [THColor.white, THColor.white.withOpacity(0)]
                        )
                    ),
                  ),
                ),
...
/// 多项联动选择器
class THMultiLinkedPicker extends StatefulWidget {
  /// 选择器标题
  final String? title;
  ...
  @override
  State<StatefulWidget> createState() => _THMultiLinkedPickerState();
}

class _THMultiLinkedPickerState extends State<THMultiLinkedPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: widget.backgroundColor ?? THColor.white,
        borderRadius: BorderRadius.only(
