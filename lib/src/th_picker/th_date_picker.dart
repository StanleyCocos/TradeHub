...
import 'package:trade_hub/src/th_picker/th_item_widget.dart';
...
/// 时间选择器
class THDatePicker extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _THDatePickerState();
}

class _THDatePickerState extends State<THDatePicker> {
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
              ...
              child: THText(widget.leftText ?? "取消",
                  style: widget.leftTextStyle ??
                      TextStyle(fontSize: 12, color: THColor.black99000000))),
          ...
          GestureDetector(
            ...
            child: THText(
              ...
              style: widget.rightTextStyle ??
                  TextStyle(fontSize: 12, color: THColor.orangeED702D),
            ),
          ),
        ],
      ),
