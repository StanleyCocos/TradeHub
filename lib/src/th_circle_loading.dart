...
class THCircleLoading extends StatefulWidget {
  const THCircleLoading({
    Key? key,
    this.color,
    this.size = 20.0,
  ...
  @override
  State<THCircleLoading> createState() => _THCircleLoadingState();
}

class _THCircleLoadingState extends State<THCircleLoading>
  ...
  @override
  void didUpdateWidget(covariant THCircleLoading oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    var paintColor = widget.color ?? THColor.orangeED702D;
    return Transform(
      ...
      child: SizedBox.fromSize(
        ...
        child: CustomPaint(
          painter: _CirclePaint(color: paintColor, width: widget.strokeWidth),
        ),
      ),
    );
  }
